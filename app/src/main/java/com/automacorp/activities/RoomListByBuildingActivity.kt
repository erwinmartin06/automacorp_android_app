...
class RoomListByBuildingActivity : BasicActivity(), OnRoomClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch(context = Dispatchers.IO) {
            runCatching { ApiServices.roomsApiService.findRoomsByBuildingName(intent.getStringExtra(MainActivity.BUILDING_NAME_PARAM).toString()).execute() }
                .onSuccess {
